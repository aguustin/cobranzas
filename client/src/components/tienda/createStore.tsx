...
const CreateStore = ({setHideCreateStoreForm}: CreateStoreProps) => {
 ...
 <div className="min-h-screen text-gray-100 ">
      <div className="mx-auto">
        ...
        {/* Formulario */}
        <form onSubmit={(e) => createStore(e)} className="bg-gradient-to-br from-gray-900 to-gray-800 border border-gray-800 rounded-xl overflow-hidden shadow-xl" encType="multipart/form-data">
          <div className="p-8">
            
            {/* Nombre del Producto */}
            <div className="mb-6">
              <label className="block text-left text-md font-semibold text-gray-400 mb-2">
                Nombre de la tienda
              </label>
              <input 
            ...
            <div className="mb-6">
             ...
             <div className="mb-6">
              ...
              <div className="mt-1">
               ...
               <div>
                <label htmlFor="storeHtml" className="block p-3 text-md font-semibold text-gray-400 mb-2 mt-6 text-center text-xl bg-gray-900 border-2 rounded-xl">
                  Cargar imagen
                  ...
                  <label className="text-md text-blue-400">Puedes cargar una imagen de la tienda para que te ayude a ubicarte mejor</label>
                </label>
